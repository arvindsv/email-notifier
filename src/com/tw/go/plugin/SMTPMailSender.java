...
public class SMTPMailSender {
    ...
    public void send(String subject, String body, String toEmailId) {
        ...
        try {
            ...
            SessionWrapper session = createSession(properties, smtpSettings.getSmtpUsername(), smtpSettings.getPassword());
            ...
            MimeMessage message = session.createMessage(smtpSettings.getFromEmailId(), toEmailId, subject, body);
